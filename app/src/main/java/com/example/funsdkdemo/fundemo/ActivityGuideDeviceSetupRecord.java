...
public class ActivityGuideDeviceSetupRecord extends ActivityAll implements OnClickListener, OnFunDeviceOptListener, OnItemSelectedListener, OnSeekBarChangeListener {
