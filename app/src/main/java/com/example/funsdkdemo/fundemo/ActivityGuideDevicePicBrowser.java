...
import com.example.funsdkdemo.lib.funsdk.support.config.*;
 ...
 * Demo: 打开图片原图
 */
public class ActivityGuideDevicePicBrowser extends ActivityAll implements OnFunDeviceOptListener, View.OnClickListener, View.OnLongClickListener, OnFunDeviceFileListener {
