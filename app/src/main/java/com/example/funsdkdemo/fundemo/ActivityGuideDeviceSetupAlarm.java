...
import com.example.funsdkdemo.common.DeviceConfigType;
...
import com.example.funsdkdemo.lib.funsdk.support.config.AlarmOut.AlarmOutInfo;
...
import com.example.funsdkdemo.lib.funsdk.support.models.FunDeviceSocket;
 ...
 *
 */
public class ActivityGuideDeviceSetupAlarm extends ActivityAll implements OnClickListener, OnFunDeviceOptListener, OnItemSelectedListener {
