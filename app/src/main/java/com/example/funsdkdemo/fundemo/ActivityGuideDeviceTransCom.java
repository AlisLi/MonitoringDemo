...
import com.example.funsdkdemo.lib.funsdk.support.OnFunDeviceSerialListener;
 ...
 *
 */
public class ActivityGuideDeviceTransCom extends ActivityAll implements OnClickListener, OnFunDeviceOptListener, OnFunDeviceSerialListener {
