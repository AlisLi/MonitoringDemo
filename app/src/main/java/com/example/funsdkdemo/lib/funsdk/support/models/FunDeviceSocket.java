package com.example.funsdkdemo.lib.funsdk.support.models;


import com.example.funsdkdemo.lib.funsdk.support.config.BaseConfig;
import com.example.funsdkdemo.lib.funsdk.support.config.OPPowerSocketGet;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketArm;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketAutoLight;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketAutoSwitch;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketAutoUsb;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketBanLed;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketDelayLight;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketDelaySwitch;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketDelayUsbPower;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketImage;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketSensitive;
import com.example.funsdkdemo.lib.funsdk.support.config.PowerSocketWorkRecord;
