package com.example.funsdkdemo.lib.funsdk.support.utils;
...
import com.example.funsdkdemo.lib.funsdk.support.OnFunDeviceTalkListener;
...
public class TalkManager implements OnFunDeviceTalkListener {
    ...
    class AudioRecordThread extends Thread {
        ...
        public void Pause(boolean bPause) {
            ...
            com.example.funsdkdemo.lib.funsdk.support.config.OPTalk mOPTalk = new com.example.funsdkdemo.lib.funsdk.support.config.OPTalk();
            if (mThreadPauseFlag) {
