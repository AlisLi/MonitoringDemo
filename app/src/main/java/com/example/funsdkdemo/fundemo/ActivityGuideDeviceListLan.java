 ...
 * 5. 退出并注销监听
 */
public class ActivityGuideDeviceListLan extends ActivityAll implements OnClickListener, OnFunDeviceListener, ListAdapterFunDevice.OnFunDeviceItemClickListener {
